...
public class SuperAdminViewActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent in = new Intent(SuperAdminViewActivity.this , DetailsNewsViewActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.super_admin_view, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent in = new Intent(SuperAdminViewActivity.this , ClientAdminControlActivity.class);
            startActivity(in);
        } else if (id == R.id.nav_gallery) {
            Intent in = new Intent(SuperAdminViewActivity.this , NewSpyAcountActivity.class);
            startActivity(in);
        } else if (id == R.id.nav_slideshow) {
            Intent in = new Intent(SuperAdminViewActivity.this , SpyListActivity.class);
            startActivity(in);
        } else if (id == R.id.passwod_change) {
            Intent in = new Intent(SuperAdminViewActivity.this , SuperAdminPasswordChangActivity.class);
            startActivity(in);

        } else if (id == R.id.settings_change) {
            Intent in = new Intent(SuperAdminViewActivity.this , SettingsActivity.class);
            startActivity(in);
