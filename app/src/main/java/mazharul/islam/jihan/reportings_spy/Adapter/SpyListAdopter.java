...
public class SpyListAdopter extends BaseAdapter {

    Activity context;
    ArrayList<ReportListItem> reportListItems;

    public SpyListAdopter(Activity context, ArrayList<ReportListItem> reportListItems) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            holder = (SpyListAdopter.ViewHolder) convertView.getTag();
        }
